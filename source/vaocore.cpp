...
namespace SynthLab
{
	...
	*/
	bool VAOCore::reset(CoreProcData& processInfo)
	{
		// --- parameters
	...
	\returns true if successful, false otherwise
	*/
	bool VAOCore::update(CoreProcData& processInfo)
	{
		// --- parameters
		VAOscParameters* parameters = static_cast<VAOscParameters*>(processInfo.moduleParameters);
	...
	\returns true if successful, false otherwise
	*/
	double VAOCore::renderSawtoothSample(SynthClock& clock, bool advanceClock)
	{
		// --- NOTE:
	...
	\returns true if successful, false otherwise
	*/
	double VAOCore::renderSquareSample(SynthClock& clock, double& sawtoothSample)
	{
		// --- sum-of-saws method
	...
	\returns true if successful, false otherwise
	*/
	bool VAOCore::render(CoreProcData& processInfo)
	{
		// --- parameters
		VAOscParameters* parameters = static_cast<VAOscParameters*>(processInfo.moduleParameters);
	...
	\returns true if successful, false otherwise
	*/bool VAOCore::doNoteOn(CoreProcData& processInfo)
	{
		// --- parameters
		VAOscParameters* parameters = static_cast<VAOscParameters*>(processInfo.moduleParameters);
	...
	\returns true if successful, false otherwise
	*/
	bool VAOCore::doNoteOff(CoreProcData& processInfo)
	{
		return true;
	}
