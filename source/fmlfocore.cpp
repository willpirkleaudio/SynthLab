...
namespace SynthLab
{
	...
	*/
	bool FMLFOCore::reset(CoreProcData& processInfo)
	{
		// --- parameters
	...
	\returns true if successful, false otherwise
	*/
	bool FMLFOCore::update(CoreProcData& processInfo)
	{
		// --- parameters
		LFOParameters* parameters = static_cast<LFOParameters*>(processInfo.moduleParameters);
	...
	\returns true if successful, false otherwise
	*/
	bool FMLFOCore::render(CoreProcData& processInfo)
	{
		// --- parameters
		LFOParameters* parameters = static_cast<LFOParameters*>(processInfo.moduleParameters);
	...
	\returns true if successful, false otherwise
	*/
	bool FMLFOCore::doNoteOn(CoreProcData& processInfo)
	{
		// --- parameters
		LFOParameters* parameters = static_cast<LFOParameters*>(processInfo.moduleParameters);
	...
	\returns true if successful, false otherwise
	*/
	bool FMLFOCore::doNoteOff(CoreProcData& processInfo)
	{
		return true;
	}
