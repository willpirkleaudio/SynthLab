...
namespace SynthLab
{
    ...
    */
	LinearEGCore::LinearEGCore()
	{
		...
		moduleName = "LinEG";
		preferredIndex = 2; // ordering for user, DM only
	...
	*/
	bool LinearEGCore::reset(CoreProcData& processInfo)
	{
		// --- parameters
	...
	\returns true if successful, false otherwise
	*/
	bool LinearEGCore::update(CoreProcData& processInfo)
	{
	...
	\returns true if successful, false otherwise
	*/
	bool LinearEGCore::render(CoreProcData& processInfo)
	{
		// --- parameters
		EGParameters* parameters = static_cast<EGParameters*>(processInfo.moduleParameters);
	...
	\returns true if successful, false otherwise
	*/
	bool LinearEGCore::doNoteOn(CoreProcData& processInfo)
	{
		// --- parameters
		EGParameters* parameters = static_cast<EGParameters*>(processInfo.moduleParameters);
	...
	\returns true if successful, false otherwise
	*/
	bool LinearEGCore::doNoteOff(CoreProcData& processInfo)
	{
		// --- parameters
		EGParameters* parameters = static_cast<EGParameters*>(processInfo.moduleParameters);
    ...
    */
	void LinearEGCore::setSustainOverride(bool b)
	{
		sustainOverride = b;
	...
	*/
	double  LinearEGCore::setStepInc(double timeMsec, double scale)
	{
