...
namespace SynthLab
{
	...
	*/
	bool FourierWTCore::reset(CoreProcData& processInfo)
	{
		// --- parameters
	...
	\returns true if successful, false otherwise
	*/
	bool FourierWTCore::update(CoreProcData& processInfo)
	{
		// --- parameters
		WTOscParameters* parameters = static_cast<WTOscParameters*>(processInfo.moduleParameters);
	...
	\returns true if successful, false otherwise
	*/
	double FourierWTCore::renderSample(SynthClock& clock, double shape)
	{
	...
	\returns true if successful, false otherwise
	*/
	double  FourierWTCore::renderHardSyncSample(SynthClock& clock, double shape)
	{
		double output = 0.0;
	...
	\returns true if successful, false otherwise
	*/
	bool FourierWTCore::render(CoreProcData& processInfo)
	{
		// --- parameters
		WTOscParameters* parameters = static_cast<WTOscParameters*>(processInfo.moduleParameters);
	...
	\returns true if successful, false otherwise
	*/
	bool FourierWTCore::doNoteOn(CoreProcData& processInfo)
	{
		// --- parameters
		WTOscParameters* parameters = static_cast<WTOscParameters*>(processInfo.moduleParameters);
	...
	\returns true if successful, false otherwise
	*/
	bool FourierWTCore::doNoteOff(CoreProcData& processInfo)
	{
		return true;
	}
	...
	\returns true if successful, false otherwise
	*/
	bool FourierWTCore::createTables(double sampleRate)
	{
