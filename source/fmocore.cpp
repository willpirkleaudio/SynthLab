...
namespace SynthLab
{
	...
	*/
	bool FMOCore::reset(CoreProcData& processInfo)
	{
		// --- parameters
	...
	\returns true if successful, false otherwise
	*/
	bool FMOCore::update(CoreProcData& processInfo)
	{
		// --- parameters
		FMOperatorParameters* parameters = static_cast<FMOperatorParameters*>(processInfo.moduleParameters);
	...
	\returns true if successful, false otherwise
	*/
	bool FMOCore::render(CoreProcData& processInfo)
	{
		// --- parameters
		FMOperatorParameters* parameters = static_cast<FMOperatorParameters*>(processInfo.moduleParameters);
	...
	*/
	...
	bool FMOCore::doNoteOn(CoreProcData& processInfo)
	{
		// --- parameters
		FMOperatorParameters* parameters = static_cast<FMOperatorParameters*>(processInfo.moduleParameters);
	...
	\returns true if successful, false otherwise
	*/
	bool FMOCore::doNoteOff(CoreProcData& processInfo)
	{
		// --- parameters
		FMOperatorParameters* parameters = static_cast<FMOperatorParameters*>(processInfo.moduleParameters);
