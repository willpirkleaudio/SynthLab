...
#include "../wavetables/static_tables/drumtables.h"
...
namespace SynthLab
{
	...
	*/
	bool DrumWTCore::reset(CoreProcData& processInfo)
	{
		// --- parameters
	...
	\returns true if successful, false otherwise
	*/
	bool DrumWTCore::update(CoreProcData& processInfo)
	{
		// --- parameters
		WTOscParameters* parameters = static_cast<WTOscParameters*>(processInfo.moduleParameters);
	...
	\returns true if successful, false otherwise
	*/
	double DrumWTCore::renderSample(SynthClock& clock, bool forceLoop)
	{
		// --- read source
	...
	\returns true if successful, false otherwise
	*/
	bool DrumWTCore::render(CoreProcData& processInfo)
	{
		// --- parameters
		WTOscParameters* parameters = static_cast<WTOscParameters*>(processInfo.moduleParameters);
	...
	\returns true if successful, false otherwise
	*/
	bool DrumWTCore::doNoteOn(CoreProcData& processInfo)
	{
		// --- parameters
		WTOscParameters* parameters = static_cast<WTOscParameters*>(processInfo.moduleParameters);
	...
	\returns true if successful, false otherwise
	*/
	bool DrumWTCore::doNoteOff(CoreProcData& processInfo)
	{
		return true;
	}
