...
/**
\file   synthlabcore.cpp extracted from synthlabcore.cpp extracted from waveslicecore.cpp
\author Will Pirkle
...
namespace SynthLab
{
	...
	*/
	bool SynthLabCore::update(CoreProcData& processInfo)
	{
        ...
        // --- uncomment this variable, and the chunk of code below to experiment with
        //     modulated waveslices (it will be wierd because the slices are mapped to a
        //     C-major scale, starting at middle-C
        // double currentPitchModSemitones = 0.0;

		// --- NOTE: waveslicer is a sampler that is not designed for modultation
		//           you can experiment by changing this to if (true)
        //           the if(false) statement will throw a benign warning in Xcode
//		if (false)
//		{
...
//		}
	...
	*/
	...
	\param processInfo the thunk-barrier compliant data structure for passing all needed parameters
	*/
	void SynthLabCore::checkAddSampleSet(std::string sampleDirectory,
