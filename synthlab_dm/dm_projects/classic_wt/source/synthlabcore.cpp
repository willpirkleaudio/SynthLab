...
/**
\file   synthlabcore.cpp extracted from classicwtcore.cpp
\author Will Pirkle
...
namespace SynthLab
{
	...
	*/
	bool SynthLabCore::update(CoreProcData& processInfo)
	{
		...
		/*
			...
			For the SynthLabCore this is Hard Sync Modulation
		*/
	...
	*/
	...
	- nothing to do
     ...
     \param slTableSet a set of wavetables for a single waveform
     \param processInfo is the thunk-barrier compliant data structure for passing all needed parameters
     \param waveIndex index of the module-string that corresponds to this table; used for fast lookup
	*/
	void SynthLabCore::checkAddWavetable(SynthLabTableSet& slTableSet, CoreProcData& processInfo, uint32_t waveIndex)
	{
