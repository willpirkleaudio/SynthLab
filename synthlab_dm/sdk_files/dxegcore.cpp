...
namespace SynthLab
{
	...
	*/
	bool DXEGCore::reset(CoreProcData& processInfo)
	{
		// --- parameters
	...
	\returns true if successful, false otherwise
	*/
	bool DXEGCore::update(CoreProcData& processInfo)
	{
		// --- parameters
		EGParameters* parameters = static_cast<EGParameters*>(processInfo.moduleParameters);
	...
	\returns true if successful, false otherwise
	*/
	bool DXEGCore::render(CoreProcData& processInfo)
	{
		// --- parameters
		EGParameters* parameters = static_cast<EGParameters*>(processInfo.moduleParameters);
	...
	\returns true if successful, false otherwise
	*/
	bool DXEGCore::doNoteOn(CoreProcData& processInfo)
	{
		// --- parameters
		EGParameters* parameters = static_cast<EGParameters*>(processInfo.moduleParameters);
	...
	\returns true if successful, false otherwise
	*/
	bool DXEGCore::doNoteOff(CoreProcData& processInfo)
	{
		// --- parameters
		EGParameters* parameters = static_cast<EGParameters*>(processInfo.moduleParameters);
    ...
    */
	void DXEGCore::setSustainOverride(bool b)
	{
		sustainOverride = b;
	...
	*/
	double  DXEGCore::setStepInc(double timeMsec, double scale)
	{
